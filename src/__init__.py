...
- sae_model: Sparse Autoencoder architecture (standard L1-based)
- fc_sae_model: Feature Choice SAE (per-feature sparsity constraint)
...
Example usage:
    ...
    >>> from src.fc_sae_model import create_fc_sae_for_gpt2
    ...
    >>>
    >>> # Or create Feature Choice SAE
    >>> fc_sae = create_fc_sae_for_gpt2(expansion_factor=16, m_tokens_per_feature=32)
"""
...
from .fc_sae_model import FeatureChoiceSAE, FeatureChoiceTopKSAE, create_fc_sae_for_gpt2
...
__all__ = [
    ...
    "create_sae_for_gpt2",
    "FeatureChoiceSAE",
    "FeatureChoiceTopKSAE",
    "create_fc_sae_for_gpt2",
    "SAETrainer",
    "train_sae",
    "FeatureAnalyzer",
]
